(function($) {
	$.fn.html5lightbox = function(k) {
		...
		l.createMarkup = function() {
			...
			l.$lightbox = jQuery("<div id='html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999999;'>" + "<div id='html5-lightbox-overlay' style='display:block;position:absolute;top:0px;left:0px;width:100%;height:100%;background-color:" + l.options.overlaybgcolor + ";opacity:" + l.options.overlayopacity + ";filter:alpha(opacity=" + Math.round(l.options.overlayopacity * 100) + ");'></div>" + "<div id='html5-lightbox-box' style='display:block;position:relative;margin:0px auto;overflow:hidden;'>" + "<div id='html5-elem-box' style='display:block;position:relative;margin:0px auto;text-align:center;'>" + "<div id='html5-elem-wrap' style='display:block;position:relative;margin:0px auto;text-align:center;background-color:" + l.options.bgcolor + ";'>" + "<div id='html5-loading' style='display:none;position:absolute;top:0px;left:0px;text-align:center;width:100%;height:100%;background:url(\"" + l.options.skinfolder + l.options.loadingimage + "\") no-repeat center center;'></div>" + "<div id='html5-error' class='html5-error' style='display:none;position:absolute;padding:" + l.options.bordersize + "px;text-align:center;width:" + l.options.errorwidth + "px;height:" + l.options.errorheight + "px;'>" + "The requested content cannot be loaded.<br />Please try again later." + "</div>" + "<div id='html5-image' style='display:none;position:absolute;top:0px;left:0px;padding:" + l.options.bordersize + "px;text-align:center;'></div>" + "</div>" + "<div id='html5-next' style='display:none;cursor:pointer;position:absolute;right:" + l.options.bordersize + "px;top:40%;'><img src='" + l.options.skinfolder + l.options.nextimage + "'></div>" + "<div id='html5-prev' style='display:none;cursor:pointer;position:absolute;left:" + l.options.bordersize + "px;top:40%;'><img src='" + l.options.skinfolder + l.options.previmage + "'></div>" + "</div>" + "<div id='html5-elem-data-box' style='display:none;position:relative;width:100%;margin:0px auto;height:" + l.options.barheight + "px;background-color:" + l.options.bgcolor + ";'>" + "<div id='html5-text' style='display:block;float:left;overflow:hidden;margin-left:" + l.options.bordersize + "px;'></div>" + "<div id='html5-close' style='display:block;cursor:pointer;float:right;margin-right:" + l.options.bordersize + "px;'><img src='" + l.options.skinfolder + l.options.closeimage + "'></div>" + "</div>"  + "</div>" + "</div>");
			l.$lightbox.css({
	...
	$.fn.html5zoo = function(G) {
		...
		J.prototype = {
			...
			createMarkup: function() {
				this.$wrapper = jQuery("" + "<div class='html5zoo-wrapper-" + this.id + "'>" + "<div class='html5zoo-background-image-" + this.id + "'></div>" + "<div class='html5zoo-bottom-shadow-" + this.id + "'></div>" + "<div class='html5zoo-slider-" + this.id + "'>" + "<div class='html5zoo-box-" + this.id + "'>" + "<div class='html5zoo-swipe-box-" + this.id + "'>" + "<div class='html5zoo-space-" + this.id + "'></div>" + "<div class='html5zoo-img-box-" + this.id + "'></div>" + "</div>" + "</div>" + "<div class='html5zoo-text-wrapper-" + this.id + "'></div>" + "<div class='html5zoo-play-" + this.id + "'></div>" + "<div class='html5zoo-video-wrapper-" + this.id + "'></div>" + "<div class='html5zoo-ribbon-" + this.id + "'></div>" + "<div class='html5zoo-arrow-left-" + this.id + "'></div>" + "<div class='html5zoo-arrow-right-" + this.id + "'></div>" + "<div class='html5zoo-timer-" + this.id + "'></div>" + "</div>" + "<div class='html5zoo-nav-" + this.id + "'><div class='html5zoo-nav-container-" + this.id + "'></div></div>" + "</div>");
				...
				if(this.options.arrowstyle == 'always') {
					...
					$(".html5zoo-slider-" + this.id, this.container).hover(function() {
						...
						if(ASPlatforms.isIE678()) {
							...
							$(".html5zoo-arrow-left-" + a.id, a.container).fadeIn(0);
							$(".html5zoo-arrow-right-" + a.id, a.container).fadeIn(0)
						}
					}, function() {
						a.arrowTimeout = setTimeout(function() {
							if(ASPlatforms.isIE678()) {
								...
								$(".html5zoo-arrow-left-" + a.id, a.container).fadeOut(0);
								$(".html5zoo-arrow-right-" + a.id, a.container).fadeOut(0)
							}
